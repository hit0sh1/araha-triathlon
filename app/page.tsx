    ...
    <main className="min-h-screen">
      ...
      <section id="event-info" className="py-16 px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">大会概要</h2>
          <p className="text-gray-600 text-lg">各種目の詳細情報をご確認ください</p>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">コースマップ</h2>
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="aspect-w-16 aspect-h-9 bg-gray-200 rounded-lg overflow-hidden">
              <div className="w-full h-96 bg-gradient-to-br from-blue-100 to-blue-300 flex items-center justify-center">
                <p className="text-2xl text-gray-600">インタラクティブなコースマップ</p>
              </div>
            </div>
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">アラハビーチ</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">ビーチパーク内</p>
              </div>
              <div className="text-center">
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">タイムスケジュール</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">過去の大会の様子</h2>
          <div className="grid md:grid-cols-3 gap-4">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="relative group overflow-hidden rounded-lg shadow-lg">
                <img
                  src={`https://images.unsplash.com/photo-${
                    i === 1 ? '1530549821305-a40e8da5ae64' :
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">参加者の声</h2>
              ...
              <div key={index} className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-600">{testimonial.age} / 完走タイム: {testimonial.time}</p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">よくある質問</h2>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">アクセス情報</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">スポンサー</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="bg-white rounded-lg shadow-md p-6 flex items-center justify-center h-24 hover:shadow-lg transition-shadow">
                <p className="text-gray-400 font-semibold">スポンサー {i + 1}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500 to-red-500 text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <div className="space-x-4">
            <Link
              href="/entry"
              className="inline-block bg-white text-orange-500 hover:bg-gray-100 px-8 py-4 rounded-lg text-lg font-semibold transition-all transform hover:scale-105"
            >
              今すぐエントリー
            </Link>
